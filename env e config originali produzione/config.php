...
define('APP_URL', $_ENV['APP_URL'] ?? 'https://trovaveterinario.com');

// Database Configuration
define('DB_HOST', $_ENV['DB_HOST'] ?? 'localhost');
define('DB_PORT', $_ENV['DB_PORT'] ?? '3306');
define('DB_NAME', $_ENV['DB_NAME'] ?? 'trovaveterinario_db');
define('DB_USER', $_ENV['DB_USER'] ?? 'trovaveterinario_us3r');
define('DB_PASS', $_ENV['DB_PASS'] ?? '3mP0?k^yWx9Wrekv');
